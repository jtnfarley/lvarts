...
export default async function Nav(props: {user?:User, shade?:string, theme?:'lvartsmusic'}) {
	const {user} = props;
	let hasNotis = false;
	...
	return (
		<div>
			{user ?
				<NavClient user={user} hasNotis={hasNotis} hasNewNotifications={hasNewNotifications} shade={props.shade} theme={props.theme}/>
				:
